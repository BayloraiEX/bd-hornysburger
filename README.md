...
-- Hornys Burgers
	...
	-- Chicken
	hb_chicken_fillets           = { name = 'hb_chicken_fillets',     label = 'Chicken Fillets',          weight = 200,       type = 'item',      image = 'hb_chicken_fillets.png',   unique = false,     useable = true,     shouldClose = true, description = 'Plenty of Fillets'},
